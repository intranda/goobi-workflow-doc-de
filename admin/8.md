...
* Die testaccounts ins LDAP schreiben, dabei `dn`, `sambaPrimaryGroupSID` und `sambaSID` in der Datei`testuser.ldif` anpassen:
...
* Für Goobi workflow die SID ändern und den userDN anpassen:
