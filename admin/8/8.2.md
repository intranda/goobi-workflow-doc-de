...
{% hint style="info" %}
DEPRECATED: Diese Anleitung wird nicht mehr gepflegt, wir empfehlen die:
{% endhint %}
...
## Variablen and Aliase <a href="variablen-und-aliase" id="variablen-und-aliase"></a>
...
## Konfiguration der Services <a href="services-konfigurieren" id="services-konfigurieren"></a>
...
### Konfiguration des Apache <a href="apache" id="apache"></a>
...
## Erstellung der Verzeichnisstruktur <a href="verzeichnisstruktur-erstellen" id="verzeichnisstruktur-erstellen"></a>
...
## Deployment der Plugins <a href="deployment-von-plugins" id="deployment-von-plugins"></a>
...
## Konfiguration und Einstellungen <a href="goobi-einstellungen" id="goobi-einstellungen"></a>

### Konfigurationsdatei**: goobi\_config.properties** <a href="goobi_config-properties" id="goobi_config-properties"></a>

### Nutzer im LDAP anlegen <a href="benutzer-ins-ldap-schreiben-und-intrandasupport-account-anlegen" id="benutzer-ins-ldap-schreiben-und-intrandasupport-account-anlegen"></a>
...
Die Home-Verzeichnisse für die Benutzer werden erstellt, aber stellen Sie zunächst sicher, dass die Benutzer dem System bekannt sind:

```bash
id testadmin
```

Wenn Sie die Meldung `no such user` sehen, versuchen Sie:
...
Wenn der Benutzer testadmin gefunden wird, fahren Sie mit der Erstellung des Home-Verzeichnisses fort:
...
Außerdem wird die `SID` für Goobi workflow geändert, der Wert für die `userDN` angepasst, das gerade installierte lokale ldap verwendet und ein unbenutzter Benutzer entfernt:
...
Ein Test des SMB-Zugriffs kann wie folgt durchgeführt werden:
...
Mit dem Account `testadmin` und dem angegebenen Passwort `$PW_GOOBITESTUSER` ist es nun möglich, sich anzumelden. Die Anwendung läuft unter folgender URL: [http://$NAME\_HOST/goobi/uii/index.xhtml](http://$name\_host/goobi/uii/index.xhtml)
...
#### Konfigurationsdatei**: goobi\_opac.xml** <a href="goobi_opac-xml" id="goobi_opac-xml"></a>
...
#### Konfigurationsdatei**: goobi\_projects.xml** <a href="goobi_projects-xml" id="goobi_projects-xml"></a>
...
#### Konfigurationsdatei**: goobi\_digitalCollections.xml** <a href="goobi_digitalcollections-xml" id="goobi_digitalcollections-xml"></a>
