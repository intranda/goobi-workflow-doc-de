...
```bash
# OPAC: PICA
sudo wget "https://github.com/intranda/goobi-plugin-opac-pica/releases/latest/download/plugin_intranda_opac_pica.jar" -O /opt/digiverso/goobi/plugins/opac/plugin_intranda_opac_pica.jar

# OPAC: MARC
sudo wget "https://github.com/intranda/goobi-plugin-opac-marc/releases/latest/download/plugin_intranda_opac_marc.jar" -O /opt/digiverso/goobi/plugins/opac/plugin_intranda_opac_marc.jar

# Step: Fileupload
sudo wget "https://github.com/intranda/goobi-plugin-step-fileupload/releases/latest/download/plugin_intranda_step_fileUpload-GUI.jar" -O /opt/digiverso/goobi/plugins/GUI/plugin_intranda_step_fileUpload-GUI.jar
sudo wget "https://github.com/intranda/goobi-plugin-step-fileupload/releases/latest/download/plugin_intranda_step_fileUpload.jar" -O /opt/digiverso/goobi/plugins/step/plugin_intranda_step_fileUpload.jar
sudo wget "https://github.com/intranda/goobi-plugin-step-fileupload/releases/latest/download/plugin_intranda_step_fileUpload.xml" -O /opt/digiverso/goobi/config/plugin_intranda_step_fileUpload.xml

# Step: ImageQA
sudo wget "https://github.com/intranda/goobi-plugin-step-imageqa/releases/latest/download/plugin_intranda_step_imageQA-GUI.jar" -O /opt/digiverso/goobi/plugins/GUI/plugin_intranda_step_imageQA-GUI.jar
sudo wget "https://github.com/intranda/goobi-plugin-step-imageqa/releases/latest/download/plugin_intranda_step_imageQA.jar" -O /opt/digiverso/goobi/plugins/step/plugin_intranda_step_imageQA.jar
sudo wget "https://github.com/intranda/goobi-plugin-step-imageqa/releases/latest/download/plugin_intranda_step_imageQA.xml" -O /opt/digiverso/goobi/config/plugin_intranda_step_imageQA.xml

# Dashboard: Extended
sudo wget "https://github.com/intranda/goobi-plugin-dashboard-extended/releases/latest/download/plugin_intranda_dashboard_extended-GUI.jar" -O /opt/digiverso/goobi/plugins/GUI/plugin_intranda_dashboard_extended-GUI.jar
sudo wget "https://github.com/intranda/goobi-plugin-dashboard-extended/releases/latest/download/plugin_intranda_dashboard_extended.jar" -O /opt/digiverso/goobi/plugins/dashboard/plugin_intranda_dashboard_extended.jar
sudo wget "https://github.com/intranda/goobi-plugin-dashboard-extended/releases/latest/download/plugin_intranda_dashboard_extended.xml" -O /tmp/plugin_intranda_dashboard_extended.xml
sed -e's|<html-box-show>true</html-box-show>|<html-box-show>false</html-box-show>|' "/tmp/plugin/plugin_intranda_dashboard_extended.xml" | sudo tee /opt/digiverso/goobi/config/plugin_intranda_dashboard_extended.xml

# REST: intranda REST
sudo wget "https://github.com/intranda/goobi-plugin-rest-intranda/releases/latest/download/plugin_intranda_rest_default.jar" -O /opt/digiverso/goobi/plugins/lib/plugin_intranda_rest_default.jar

# Controlling: intranda default statistics
sudo wget "https://github.com/intranda/goobi-plugin-statistics-intranda/releases/latest/download/plugin_intranda_statistics-GUI.jar" -O /opt/digiverso/goobi/plugins/GUI/plugin_intranda_statistics-GUI.jar
sudo wget "https://github.com/intranda/goobi-plugin-statistics-intranda/releases/latest/download/plugin_intranda_statistics.jar" -O /opt/digiverso/goobi/plugins/statistics/plugin_intranda_statistics.jar
sudo wget "https://github.com/intranda/goobi-plugin-statistics-intranda/releases/latest/download/statistics_template.pdf" -O /opt/digiverso/goobi/plugins/statistics/statistics_template.pdf
sudo wget "https://github.com/intranda/goobi-plugin-statistics-intranda/releases/latest/download/statistics_template.xls" -O /opt/digiverso/goobi/plugins/statistics/statistics_template.xls
```
