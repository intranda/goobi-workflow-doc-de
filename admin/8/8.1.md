...
sed -e's|<html-box-show>true</html-box-show>|<html-box-show>false</html-box-show>|' "/tmp/plugin_intranda_dashboard_extended.xml" | sudo tee /opt/digiverso/goobi/config/plugin_intranda_dashboard_extended.xml

# REST: intranda REST
sudo wget "https://github.com/intranda/goobi-plugin-rest-intranda/releases/latest/download/plugin_intranda_rest_default.jar" -O /opt/digiverso/goobi/lib/plugin_intranda_rest_default.jar
