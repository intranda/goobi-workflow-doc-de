...
# Dashboard: Extended
cd $SOURCEDIR
git clone --depth 1 https://github.com/intranda/goobi-plugin-dashboard-extended.git
cd $SOURCEDIR/goobi-plugin-dashboard-extended/plugin
mvn package
sudo cp $SOURCEDIR/goobi-plugin-dashboard-extended/plugin/module-gui/target/plugin_intranda_dashboard_extended-GUI.jar /opt/digiverso/goobi/plugins/GUI/
sudo cp $SOURCEDIR/goobi-plugin-dashboard-extended/plugin/module-main/target/plugin_intranda_dashboard_extended.jar /opt/digiverso/goobi/plugins/dashboard/
sed -e's|<html-box-show>true</html-box-show>|<html-box-show>false</html-box-show>|' "$SOURCEDIR/goobi-plugin-dashboard-extended/plugin/plugin_intranda_dashboard_extended.xml" | sudo tee /opt/digiverso/goobi/config/plugin_intranda_dashboard_extended.xml
