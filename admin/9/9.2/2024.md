...
Bitte lesen Sie alle Details in der [Dokumentation des Vokabularservers](https://gitea.intranda.com/intranda/vocabulary-server/src/branch/develop/docs/de/README.md) nach.
