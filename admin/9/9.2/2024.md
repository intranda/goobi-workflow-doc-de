...
### Vokabularserver
Der Zugriff auf den Vokabularserver wird nun über ein zusätzliches Token abgesichert. In der Config-Datei `application.properties` muss der Token `security.token=CHANGEME` ergänzt werden.
