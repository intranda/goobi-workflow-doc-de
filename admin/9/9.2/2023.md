...
Wenn `grep 0.0.0.0 /opt/digiverso/goobi/config/goobi_activemq.xml` und `netstat -tulpn|grep ":::61613"` oder `netstat -tulpn|grep "0.0.0.0:61613"` nichts anzeigt muss hier nichts gemacht werden.
