...
Das Plugin `intranda_statistics_sudan_activity_by_user` wurde umbenannt zu `intranda_statistics_sudan_memory_activity_by_user`. Auf dem System muss daher beim Update die bisherigen Dateien durch die Dateien mit neuen Namen ersetzt werden:

~~`plugin_intranda_statistics_sudan.jar`~~<br/>
~~`plugin_intranda_statistics_sudan-GUI.jar`~~<br/>

`plugin_intranda_statistics_sudan_memory.jar`<br/>
