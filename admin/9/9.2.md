...
## 22.08.x-SNAPSHOT (Noch nicht veröffentlicht)
...
**Diesen Punkt nur anwenden, wenn diese Funktion verwendet wird.** Wenn die folgende SQL-Query keine Ergebnisse liefert, wird diese Funktion nicht genutzt: `mysql goobi -NBse 'select * from processlog where type="file" limit 10'`
