...
## Noch nicht veröffentlichte Version (SNAPSHOT 22.08)
...
Damit eventuell vorhandene Bildkommentare vom bisherigen Ort an den neuen Ort bewegt werden, muss das folgende Script aufgerufen werden:

```bash
#!/bin/bash
find /opt/digiverso/goobi/metadata/*/images/*_master -name "imageComments.json" -execdir mv {} ../comments_master.json \;
find /opt/digiverso/goobi/metadata/*/images/*_media -name "imageComments.json" -execdir mv {} ../comments_media.json \;
```
