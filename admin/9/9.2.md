...
https://github.com/intranda/goobi-plugin-administration-config-file-editor/blob/master/plugin/plugin_intranda_administration_config_file_editor.xml
...
xmlstarlet tr <(echo "$XSL") $file | xmlstarlet fo -e utf8 -s 4 > ${file}.tmp
mv ${file}.tmp ${file}
```
