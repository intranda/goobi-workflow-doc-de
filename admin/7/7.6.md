...
| `isdoctype` | Mithilfe des Attributs `isdoctype` lässt sich steuern, für welche Publikationstypen ein Metadatum angezeigt werden soll. Die hier verwendeten Namen der Publikationstypen müssen in der Datei `goobi_opac.xml` definiert worden sein. |
