...
| `UserForImageReading` | Text | `root` |  |
| `MetsEditorEnableImageAssignment` | Boolean | `true` |  |
| `MetsEditorRenameImagesOnExit` | Boolean | `false` |  |
| `MetsEditorValidateImages` | Boolean | `true` |  |
| `MetsEditorNumberOfImagesPerPage` | Number | `96` |  |
| `MetsEditorThumbnailsize` | Number | `200` |  |
| `MetsEditorImageSize` | Text | | LIST |
| `MetsEditorImageTileSize` | Text | | LIST |
| `MetsEditorImageTileScale` | Text | | LIST |
| `MetsEditorMaxImageSize` | Number | `15000` |  |
| `MaxImageFileSize` | Number | `4000` |  |
| `MaxImageFileSizeUnit` | Text | `MB` |  |
| `MetsEditorUseImageTiles` | Boolean | `true` |  |
| `historyImageSuffix` | Text | `.tif` | LIST |
| `MetsEditorMaxTitleLength` | Number | `0` |  |
| `validateProcessTitelRegex` | Text | `[\\w-]*` |  |
| `ProcessTitleGenerationRegex` | Text | `[\\W]` |  |
| `exportWithoutTimeLimit` | Boolean | `true` |  |
| `automaticExportWithImages` | Boolean | `true` |  |
| `automaticExportWithOcr` | Boolean | `true` |  |
| `useOrigFolder` | Boolean | `true` |  |
| `pdfAsDownload` | Boolean | `true` |  |
| `ExportFilesFromOptionalMetsFileGroups` | Boolean | `false` |  |
| `ExportValidateImages` | Boolean | `true` |  |
| `ExportInTemporaryFile` | Boolean | `false` |  |
| `ExportCreateUUID` | Boolean | `true` |  |
| `ExportCreateTechnicalMetadata` | Boolean | `false` |  |
| `ExportMetadataForProject` | Text | |  |
| `ExportMetadataForInstitution` | Text | |  |
| `typeOfBackup` | Text | `renameFile` |  |
| `formatOfMetaBackups` | Text | `` |  |
| `numberOfMetaBackups` | Number | `0` |  |
