...
| `index` | ??? | | Dieser Wert kann mehrfach verwendet werden. |
<!--- was macht dieser Wert??? -> Listenoptionen angeben -->
...
| `pdfAsDownload` | Boolean | `true` | Dieser Wert kann auf `true` gesetzt werden, um Vorgänge nicht mit Hilfe des ContentServers, sondern direkt zu exportieren. |
