...
| Eigenschaft | Typ | Standardwert | Beschreibung |
| ----------- | --- | ------------ | ------------ |
| `ProcessCreationResetLog` | Boolean | `false` | Dieser Wert kann auf `true` gesetzt werden, um beim Duplizieren eines Vorgangs das Vorgangslog nicht mitzukopieren. |
...
| `ProcessLogShowSecondField` | Boolean | `false` | Diese Einstellung kann auf `true` gesetzt werden, um im Vorgangslog ein zweites Texteingabefeld `Version` anzuzeigen. |
| `ProcessLogShowThirdField` | Boolean | `false` | Diese Einstellung kann auf `true` gesetzt werden, um im Vorgangslog ein drittes Texteingabefeld `Zusatz` anzuzeigen. |
...
| Eigenschaft | Typ | Standardwert | Beschreibung |
| ----------- | --- | ------------ | ------------ |
| `http_useProxy` | Boolean | `false` | Dieser Schalter wird auf `true` gesetzt, um die Verwendung eines Proxy-Servers zu aktivieren. |
